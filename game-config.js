...
window.AlienGame = Object.hasOwn(LegendarySetup.titles,requestedGame)
  ? { id: requestedGame, title: LegendarySetup.titles[requestedGame], collection: true, data: `games/${requestedGame}/data.json?v=1`, saveKey: `legendary-${requestedGame}-state-v1`, previousKey: `legendary-${requestedGame}-before-import-v1` }
